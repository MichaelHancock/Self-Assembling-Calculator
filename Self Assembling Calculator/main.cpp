...
std::vector<std::string> composeFunctions(std::string, std::string, int, bool);
...
int main() {
	...
	for (int i = 1; i < 7; i++) {
		...
		std::vector<std::string> functions = composeFunctions(outputPath, requires, i, true);
...
std::vector<std::string> composeFunctions(std::string outputPath, std::string requiredInterfaces, int solutionLength, bool shouldWrite) {
